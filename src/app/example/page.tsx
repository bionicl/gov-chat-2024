...
import { Button, Descriptions, DescriptionsProps, Input, Space, Typography } from "antd";
...
export default function Page() {
    ...
    return <Space direction="vertical"><Input onChange={(e) => setMessyValue(e.target.value)} value={messyValue}/>
    <Button onClick={callApi} loading={loading} disabled={loading}>Submit</Button>
    {output !== null && (
